...
export const airportService = {
  ...
  { "iata": "VGA", "name": "Vijayawada Airport", "city": "Vijayawada", "country": "India" },
  ...
  { "iata": "IXZ", "name": "Veer Savarkar International Airport", "city": "Port Blair", "country": "India" },
  {"iata":"PAT","name":"Lok Nayak Jayaprakash Airport","city":"Patna","country":"India"},
...
const generateMockFlights = (departureAirport: string, arrivalAirport: string, date: string) => {
  ...
  const airports: Record<string, { name: string; timezone: string }> = {
    ...
    BBI: { name: "Biju Patnaik International Airport", timezone: "Asia/Kolkata" },
    ...
    LKO: { name: "Chaudhary Charan Singh International Airport", timezone: "Asia/Kolkata" },
    IXZ: { name: "Veer Savarkar International Airport", timezone: "Asia/Kolkata" },
    ...
    JNB: { name: "O.R. Tambo International Airport", timezone: "Africa/Johannesburg" },
    SVO: { name: "Sheremetyevo International Airport", timezone: "Europe/Moscow" },
    ...
    CAN: { name: "Guangzhou Baiyun International Airport", timezone: "Asia/Shanghai" },
    // AMS: { name: "Amsterdam Schiphol Airport", timezone: "Europe/Amsterdam" },
    // FRA: { name: "Frankfurt Airport", timezone: "Europe/Berlin" },
    // IST: { name: "Istanbul Airport", timezone: "Europe/Istanbul" },
    // SIN: { name: "Singapore Changi Airport", timezone: "Asia/Singapore" },
    ...
    KUL: { name: "Kuala Lumpur International Airport", timezone: "Asia/Kuala_Lumpur" },
    // HKG: { name: "Hong Kong International Airport", timezone: "Asia/Hong_Kong" },
    // BKK: { name: "Suvarnabhumi Airport", timezone: "Asia/Bangkok" },
    SFO: { name: "San Francisco International Airport", timezone: "America/Los_Angeles" },
    MUC: { name: "Munich Airport", timezone: "Europe/Berlin" },
    MNL: { name: "Ninoy Aquino International Airport", timezone: "Asia/Manila" },
    GIG: { name: "Rio de Janeiro-Galeão International Airport", timezone: "America/Sao_Paulo" },
    CPT: { name: "Cape Town International Airport", timezone: "Africa/Johannesburg" },
    // NRT: { name: "Narita International Airport", timezone: "Asia/Tokyo" },
